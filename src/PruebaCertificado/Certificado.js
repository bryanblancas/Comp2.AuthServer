...
async function prueba() {
	let pemFile = fs.readFileSync('/home/diegoarturomg/Documents/TT_Private/Componente_2/src/certificadoServidor.crt', 'utf8');
	certificateBuffer = convertPemToBinary(pemFile);
	//console.log(certificateBuffer);
	//printCertificate(certificateBuffer);

	pemFile = fs.readFileSync('/home/diegoarturomg/Documents/TT_Private/Componente_2/src/certificadoServidor.crt', 'utf8');
	certificateBuffer = convertPemToBinary(pemFile);
...
*/
	...
	try {
		pemFile = fs.readFileSync('/home/diegoarturomg/Documents/TT_Private/Componente_2/src/myKey.pem', 'utf8');
